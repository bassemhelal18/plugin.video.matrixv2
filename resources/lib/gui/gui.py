...
#kasi
    ...
    def createListItem(self, oGuiElement):
        ...
        videoInfoTag.setMpaa(str(itemValues.get('mpaa', "")))
        videoInfoTag.setPremiered(str(itemValues.get('premiered', "")))
        videoInfoTag.setDateAdded(str(itemValues.get('date')))
        videoInfoTag.setFirstAired(str(itemValues.get('aired')))
        videoInfoTag.setDuration(int(itemValues.get('duration', 0)))
        videoInfoTag.setPlaycount(int(itemValues.get('playcount', 0)))
        videoInfoTag.setTrailer(str(itemValues.get('trailer', "")))
        videoInfoTag.setTagLine(str(itemValues.get('tagline', "")))
    ...
    @staticmethod
    def showInfo(sTitle='Matrixv2', sDescription=cConfig().getLocalizedString(30253), iSeconds=0):
        if iSeconds == 0:
            iSeconds = 1000
        else:
            iSeconds = iSeconds * 1000
    ...
    @staticmethod
    def showLanguage(sTitle='Matrixv2', sDescription=cConfig().getLocalizedString(30403), iSeconds=0):
        if iSeconds == 0:
            iSeconds = 1000
        else:
            iSeconds = iSeconds * 1000
