...
class cRequestHandler:
    ...
    def request(self):
        ...
        self._sUrl = urllib.parse.urlsplit(self._sUrl)
        self._sUrl = list(self._sUrl)
        self._sUrl[2] = urllib.parse.quote(self._sUrl[2])
        self._sUrl = urllib.parse.urlunsplit(self._sUrl)
    ...
    def clearCache(self):
        ...
        for file in files:
            ...
            xbmcgui.Dialog().notification('Matrixv2', cConfig().getLocalizedString(30405), xbmcgui.NOTIFICATION_INFO, 100, False)
