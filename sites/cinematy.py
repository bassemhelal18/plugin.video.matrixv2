...
# Domain Abfrage
DOMAIN = cConfig().getSetting('plugin_'+ SITE_IDENTIFIER +'.domain', 'ciinematy.org')
                ...
                for sHosterID ,serverId  in aResult:
                 ...
                 if isMatch:
                  for sUrl4  in aResult:
                    megamax = next((x for x in ['megamax', 'm3lomatik', 'ciinematy', 'nematyko.store'] if x in sUrl4), None)
                    if megamax:
